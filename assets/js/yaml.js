...
function validateYAML(){
    ...
    try{
	    var obj = YAML.parse(input);
	    document.getElementById("output").value = "Valid YAML!";
    }
    catch(e){
        document.getElementById("output").value = "Invalid YAML! \n\n"+e;
    }
}
...
function formatYAML(){
    ...
    try{
	    var obj = YAML.parse(input);
	    document.getElementById("output").value = YAML.stringify(obj, 2);
    }
    catch(e){
        document.getElementById("output").value = "Invalid YAML! \n\n"+e;
    }
...
function yaml2json(){
    ...
    try{
	    var obj = YAML.parse(input);
	    document.getElementById("output").value = JSON.stringify(obj, 2);
    }
    catch(e){
        document.getElementById("output").value = "Invalid JSON! \n\n"+e;
    }
